...
public class ReadingDataHandler {
  ...
  public long getInt64(long index) {
    return imebraJNI.ReadingDataHandler_getInt64(swigCPtr, this, index);
  }
  ...
  public java.math.BigInteger getUint64(long index) {
    return imebraJNI.ReadingDataHandler_getUint64(swigCPtr, this, index);
  }
